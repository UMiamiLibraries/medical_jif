...
if __name__ == "__main__":
    ##RUN THIS FIRST. UPDATE THE FILE NAMES AT THE TOP, THEN RUN. THIS WILL GENERATE THE SCOPUS VALUES. 
    ##NEXT, RUN WOS_WITH_GIVEN_ISSNS.PY
    ##FINALLY RUN THE GENERATION_CITATIONS.PY
    start = 0
